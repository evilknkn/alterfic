...
<div class="page-content" ng-controller="apartadoPendienteAsignadosCtrl" >
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            ...
            <div class="table-responsive">
                <div class="row " style="margin-bottom:20px;">
                    <a href="<?=base_url()?>excel/apartados/info/pendientesAsignar" id="exportar-general"  class="btn btn-success" > Exportar a Excel </a>
                </div>
                <div class="row" ng-init="listaPendientes('<?=base_url()?>')">
                    ...
                    <table datatable="ng" dt-options="dtOptions" class="row-border hover">
                        ...
                        <tbody>
                            ...
                            <tr ng-repeat="deposito in list_depositos" id="deposito_{{deposito.id_deposito}}">
                                <td>{{ deposito.nombre_empresa }}  {{deposito_.id_deposito}}</td>
