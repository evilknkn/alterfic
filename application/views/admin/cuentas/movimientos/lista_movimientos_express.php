        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <?php if($this->session->userdata('consulta') == 'active'): ?>
                    <a href="<?=base_url('cuentas/movimientos_internos_express/add_mov_interno/'.$id_empresa.'/'.$id_banco)?>" class="btn btn-primary" >
                        Agregar movimiento
                    </a>

                    <a class="btn btn-grey" style="margin-left:10px" href="<?=base_url('cuentas/depositos/detalle_cuenta/'.$id_empresa.'/'.$id_banco)?>"> <i class="fa fa-undo"></i> Regresar</a>
...
<?=$this->load->view('admin/cuentas/movimientos/modal_movimiento_express')?>
