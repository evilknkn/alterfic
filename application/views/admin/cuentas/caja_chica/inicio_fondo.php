...
<div class="block-area" id="responsiveTable">
    ...
    <a href="<?=base_url('cuentas/caja_chica/insert_deposito/'.$id_empresa.'/'.$id_banco)?>" style="margin-left:15px" class="btn"> <i class="fa fa-plus"></i> Agregar depósito</a>
    <a href="<?=base_url('cuentas/salida/insertar_salida_caja/'.$id_empresa.'/'.$id_banco)?>" style="margin-left:15px" class="btn"> <i class="fa fa-plus"></i> Agregar Salida</a>
    <br><br>
    ...
    <div class="table-responsive overflow">
        <table class="table tile">
            <thead>
            	<tr>
            		<th colspan="12" class="text-center" ><h3> <?=$empresa->nombre_empresa?></h3></th>
            	</tr>
                <tr>
