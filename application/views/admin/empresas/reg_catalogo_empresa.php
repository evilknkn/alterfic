...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?=base_url('catalogos/corps')?>">Lista de empresas</a></li>
</div>
        ...
        <div class="col-xs-12">
            ...
            <?=form_open('',array('class' => 'form-horizontal'))?>
                ...
                <div class="text-center">
                    ...
                    <a href="<?=base_url('catalogos/corps')?>" class="btn btn-grey" style="margin-left:10px"><i class="fa fa-undo"></i> Regresar</a>
                </div>
                <?=form_close();?>
            </div>
