...
class exportaExcel extends CI_Controller
{
	...
	public function caja_chica()
	{
		...
		$movimientos 	= $this->movimiento_model->lista_movimientos($filtro, $this->session->userdata('fecha_ini_caja'), $this->session->userdata('fecha_fin_caja'));
		$db_mov 	= $this->movimiento_model;
		$empresa	= $datos_empresa;
		$id_empresa = $datos_empresa->id_empresa;
		$id_banco	= $datos_empresa->id_banco;
