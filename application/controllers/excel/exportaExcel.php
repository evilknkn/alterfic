	...
	public function detalle_depositos($id_empresa, $id_banco)
	{
        ...
        foreach($movimientos as $movimiento): 
            ...
            if($type_mov == 'deposito')
            {
                ...
                $cellRespuesta->setCellValue('B'.$i, '$'.convierte_moneda($cantidad_deposito));
                $cellRespuesta->setCellValue('C'.$i, '');
                $cellRespuesta->setCellValue('D'.$i, $movimiento->folio_mov);
                $cellRespuesta->setCellValue('E'.$i, '$'.convierte_moneda($comisio_cliente));
                $cellRespuesta->setCellValue('F'.$i, '$'.convierte_moneda($catidad_retornar));
                $cellRespuesta->setCellValue('G'.$i, '$'.convierte_moneda($pendiente));
                $cellRespuesta->setCellValue('H'.$i, '$'.convierte_moneda($pagos));
            ...
            }else
            {
                ...
                $cellRespuesta->setCellValue('C'.$i, '$'.convierte_moneda($salida->monto_salida));
                $cellRespuesta->setCellValue('D'.$i, $movimiento->folio_mov);
                $cellRespuesta->setCellValue('E'.$i, '');
                $cellRespuesta->setCellValue('F'.$i, '');
                $cellRespuesta->setCellValue('G'.$i, '');
