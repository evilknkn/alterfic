...
{	
	...
	public function editar_salida_gasto_camion($id_empresa, $id_banco, $id_salida)
	{
		$this->load->model('cuentas/salida_model');
		$this->load->model('cuentas/detalle_cuenta_model');
		$this->load->model('cuentas/depositos_model');
		...
		if($this->form_validation->run()):
			...
			$this->session->set_flashdata('success', 'Salida actualizada correctamente');
			redirect(base_url('cuentas/salida/editar_salida_gasto_camion/'.$id_empresa.'/'.$id_banco.'/'.$id_salida));

		else:
			$data = array(	'menu' 	=>  'menu/menu_admin',
							'body'	=>	'admin/cuentas/salida/edicion_salida_gasto_camion');
	...
	public function insertar_salida_gasto_camion($id_empresa, $id_banco)
	{
		$this->load->model('cuentas/salida_model');
		$this->load->model('cuentas/detalle_cuenta_model');
		$this->load->model('cuentas/depositos_model');
		...
		if($this->form_validation->run()):
			...
			$data = array(	'menu' 	=>  'menu/menu_admin',
							'body'	=>	'admin/cuentas/salida/form_salida_gasto_camion');
